...
function App() {
  ...
  return (
    ...
    <section name="seccion2" className='max-w-[1280px] mx-auto flex gap-y-6 py-11 flex-col md:flex-row'>
      <AboutSection />
    </section>
    <section name="seccion3" className="max-w-[1280px] min-h-screen bg-gray-50 py-12 px-4 flex flex-col md:flex-row">
      <MiTrayectoria />
      <Habilidades />
    </section>
